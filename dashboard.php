      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav nav-flex-icons">
            ...
            <li >
            <a  class="nav-link border border-light rounded waves-effect" href="./session_destroy.php" style="background-color:#e73b3b; color:white; margin-left:10px;">
            Cerrar sesión</a>
            </li>
          </ul>
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            <a href="https://mdbootstrap.com/docs/jquery/" target="_blank">Menú</a>
            <span>/</span>
            <span>Dashboard</span>
          </h4>
  ...
  <script>
    ...
    var myPieChart = new Chart(ctxP, {
      ...
      data: {
        ...
        datasets: [{
          data: [300, 50, 100, 40, 120,200,135],
          backgroundColor: ["#F7464A", "#46BFBD", "#FDB45C", "#949FB1", "#4D5360","#975511","#4655FF"],
